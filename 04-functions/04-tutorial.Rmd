...
```{r C5-hint-2}
"Use this within a `map_chr()`: `if_else((mean_overall > 4), 'I love this dept.', 'I don't like this dept.')`"
```
...
qscores1 %>% 
  mutate(gthan4 = map_chr(mean_overall, ~ if_else((mean_overall > 4), 'I love this dept.', 'I don't like this dept.')))
