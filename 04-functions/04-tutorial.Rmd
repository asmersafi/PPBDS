...
##  Questions on built-in functions and using them with list columns and map functions

Let's now introduce you to a series of questions that help you get the hang of using list columns and `map_*()` functions in conjunction with built-in R functions. 
