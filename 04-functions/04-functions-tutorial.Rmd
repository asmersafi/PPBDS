...
Let's practice on an actual data set. We will load the `midwest` data once more, and apply our knowledge of list columns and `map*()` functions to it. 

First, let's practice using 
